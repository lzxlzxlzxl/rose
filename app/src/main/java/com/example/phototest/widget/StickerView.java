...
import com.example.phototest.ActionImageView;
...
public class StickerView extends View implements BackTextActionListener, StopAddTextListener, RotateActionListener,
    ...
    public void setmTextsControlListener(ActionImageView mTextsControlListener) {
    ...
    public void setmBeginAddTextListener(EditTextActionLayout mBeginAddTextListener) {
        this.mBeginAddTextListener = (BeginAddTextListener) mBeginAddTextListener;
    }
    ...
    public void setmCurrentRotateRectQuery(ActionImageView mCurrentRotateRectQuery) {
